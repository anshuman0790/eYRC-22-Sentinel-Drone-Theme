...
class Edrone():
	...
	def __init__(self):
		...
		self.setpoint = [0,0,23]                   # initial setpoint
		self.wp_setpoints =[[0,0,23],
							 ...
							 [2,-2,23],
							 [2,0,23],
							 [0,0,23]]            # list of setpoints (waypoints) where quadcopter should move through
	...
	#	8. Add error_sum
		...
		if((self.setpoint[0]==0 and self.setpoint[1]==0 and self.setpoint[2]==23) and (self.s1==0)):
			if ((self.drone_position[0]<=(self.setpoint[0]+0.2) and self.drone_position[0]>=(self.setpoint[0]-0.2)) and(self.drone_position[1]<=(self.setpoint[1]+0.2) and self.drone_position[1]>=(self.setpoint[1]-0.2)) and (self.drone_position[2]<=(self.setpoint[2]+0.2) and self.drone_position[2]>=(self.setpoint[2]-0.2)) ) :
				self.setpoint[0]=2
				self.setpoint[1]=0
				self.setpoint[2]=23
				print("1")
		elif((self.setpoint[0]==2 and self.setpoint[1]==0 and self.setpoint[2]==23) and(self.s2==0)):
			if ((self.drone_position[0]<=(self.setpoint[0]+0.2) and self.drone_position[0]>=(self.setpoint[0]-0.2)) and(self.drone_position[1]<=(self.setpoint[1]+0.2) and self.drone_position[1]>=(self.setpoint[1]-0.2)) and (self.drone_position[2]<=(self.setpoint[2]+0.2) and self.drone_position[2]>=(self.setpoint[2]-0.2)) ) :
				self.setpoint[0]=2
				self.setpoint[1]=2
				self.setpoint[2]=23
				print("2")
		elif(self.setpoint[0]==2 and self.setpoint[1]==2 and self.setpoint[2]==23):
			if ((self.drone_position[0]<=(self.setpoint[0]+0.2) and self.drone_position[0]>=(self.setpoint[0]-0.2)) and(self.drone_position[1]<=(self.setpoint[1]+0.2) and self.drone_position[1]>=(self.setpoint[1]-0.2)) and (self.drone_position[2]<=(self.setpoint[2]+0.2) and self.drone_position[2]>=(self.setpoint[2]-0.2)) ) :
				self.setpoint[0]=-2
				self.setpoint[1]=2
				self.setpoint[2]=23	
			...
			if ((self.drone_position[0]<=(self.setpoint[0]+0.2) and self.drone_position[0]>=(self.setpoint[0]-0.2)) and(self.drone_position[1]<=(self.setpoint[1]+0.2) and self.drone_position[1]>=(self.setpoint[1]-0.2)) and (self.drone_position[2]<=(self.setpoint[2]+0.2) and self.drone_position[2]>=(self.setpoint[2]-0.2)) ) :
				...
				self.s2=1
				print("6")
		elif(self.setpoint[0]==2 and self.setpoint[1]==0 and self.setpoint[2]==23):
			if ((self.drone_position[0]<=(self.setpoint[0]+0.2) and self.drone_position[0]>=(self.setpoint[0]-0.2)) and(self.drone_position[1]<=(self.setpoint[1]+0.2) and self.drone_position[1]>=(self.setpoint[1]-0.2)) and (self.drone_position[2]<=(self.setpoint[2]+0.2) and self.drone_position[2]>=(self.setpoint[2]-0.2)) ) :
				self.setpoint[0]=0
				self.setpoint[1]=0
				self.setpoint[2]=23
...
if __name__ == '__main__':
	...
	e_drone = Edrone()
	r = rospy.Rate(25) #specify rate in Hz based upon your desired PID sampling time, i.e. if desired sample time is 33ms specify rate as 30Hz
